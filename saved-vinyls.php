...
if (!isset($_SESSION['user_id'])) {
    ...
    header("Location: login.php?url=saved-vinyls.php");
...
<body style="background-color:#b4bac1; height:100vh;" class="d-flex flex-column justify-content-around" >
    <?php include "assets/nav.php"; ?>
    <h1 style="font-family:Jost; width:100vw; " class="text-center mt-4" >Your Saved Vinyls</h1>
        ...
        <?php else : ?>
            <div class="vinyl-list row w-100">
                <?php foreach ($vinyls as $vinyl) : ?>
                    <div class="col-12 col-sm-6 d-flex flex-column align-items-center justify-content-center mb-1">
                        <!-- Rotative vinyl -->
                        <div class="rotative-container" style="width:400px;height:200px">
                             <div class="main-container">
                                  <!-- Cover image -->
                                  <div id="square" class="square shadow-effect" style="background:url(<?= htmlspecialchars($vinyl['imgURL']); ?>);"></div>
                                  <div class="vinyl-container">
                                       <p class="disk-text" style="font-family: <?= htmlspecialchars($vinyl['fontFamily']); ?>; font-size: <?= htmlspecialchars($vinyl['fontSize'] - 5); ?>px;">
    ...
    <footer class="footer mt-auto py-3 bg-dark text-center mb-0">
